...
function isPrimaryMouseButton(ev) {
    //console.log("Date: ",ev.target.attributes[1].value); // Hernan get date
...
var GlobalEmitter = /** @class */ (function () {
    ...
    GlobalEmitter.prototype.handleClick = function (ev) {
        if (!this.shouldIgnoreMouse()) {
            ...
            var data=[];
            data.fecha=ev.target.dataset.date;
            data.periodo="mes";
            clickDia(data); // Hernan Get Date
        }
    };
    // Misc Handlers
    // -----------------------------------------------------------------------------------------------------------------
...
exports.globalDefaults = {
    ...
    header: {
        ...
        abajo: 'doctor,paciente,especialidad' /* Hernan */
    },
    weekends: true,
    weekNumbers: false,
    weekNumberTitle: 'W',
    ...
    buttonText: {
        ...
        week: 'week',
        day: 'day',
        doctor:'doctor',/*Modificado por Hernan*/
        paciente:'paciente',
...
exports.rtlDefaults = {
    header: {
        ...
        center: '',
        right: 'title',
        abajo:'doctor,paciente,especialidad'//Modificado Hernan
    },
    buttonIcons: {
        ...
        doctor: 'right-single-arrow',
        paciente: 'right-single-arrow',
        especialidad: 'right-single-arrow'
    },
    themeButtonIcons: {
        ...
        doctor: 'circle-triangle-e',
        paciente: 'circle-triangle-e',
        especialidad: 'circle-triangle-e'
    }
};
var complexOptions = [
    'header',
...
var Theme = /** @class */ (function () {
    ...
    Theme.prototype.processIconOverride = function () {
        if (this.iconOverrideOption) {
        	//console.log("iconOverrideOption",this.iconOverrideOption)
    ...
    Theme.prototype.setIconOverride = function (iconOverrideHash) {
        var iconClassesCopy;
        var buttonName;
        //console.log($.isPlainObject(iconOverrideHash));
    ...
    Theme.prototype.getIconClass = function (buttonName) {
        ...
        if (className) {
        	//console.log(this.baseIconClass + ' ' + className)
...
var DragListener = /** @class */ (function () {
    ...
    DragListener.prototype.bindHandlers = function () {
        ...
        //console.log("bindHandlers: ",globalEmitter)
        if (this.isGeneric) {
            this.listenTo($(document), {
    ...
    DragListener.prototype.unbindHandlers = function () {
        //console.log("unbindHandlers: ",GlobalEmitter_1.default.get())
        this.stopListeningTo(GlobalEmitter_1.default.get());
    ...
    DragListener.prototype.endDrag = function (ev,extraOptions) {
        if (this.isDragging) {
            this.isDragging = false;
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.queryHit = function (leftOffset, topOffset) {
        if (this.colCoordCache.isLeftInBounds(leftOffset) && this.rowCoordCache.isTopInBounds(topOffset)) {
            ...
            if (row != null && col != null) {
                //console.log(this.getCellHit(row, col))
    ...
    DayGrid.prototype.getHitEl = function (hit) {
    	//clickDia(hit) //Hernan al click al dia del mes no este lo toma como objeto
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.changeView = function (viewName, dateOrRange) {
        if (dateOrRange) {
            if (dateOrRange.start && dateOrRange.end) {
                console.log(dateOrRange.start , dateOrRange.end)
    ...
    Calendar.prototype.initialRender = function () {
        ...
        el.on('click.fc', 'a[data-goto]', function (ev) {
            ...
            $(".fc-agendaDay-button").click(); // Hernan actualizar citas del dia //
        });
    ...
    Calendar.prototype.renderView = function (viewType) {
        ...
        //console.log("viewType: ","Inicia: ",this.view.intervalStart._d," Termina: ",this.view.intervalEnd._d);
        //console.log("viewType: ",this.view)
        var fechasCitas={};
        fechasCitas.start = moment(this.view.start._d).format('YYYY-MM-DD');
        fechasCitas.end = moment(this.view.end._d).format('YYYY-MM-DD');
        usuario.citas.fecha=fechasCitas;
        var periodo = "";
        if(this.view.name=="agendaWeek"){
            periodo = "semana";
        }else if(this.view.name=="agendaDay"){
            periodo = "dia";
        }else if(this.view.name=="listWeek"){
            periodo = "lista";
        }
        usuario.citas.periodo=periodo;
        if($("#especialidad_k").val()==undefined){
...
var EventDragging = /** @class */ (function (_super) {
    ...
    */
    ...
    EventDragging.prototype.segDragStop = function (seg, ev) {
        ...
        // var eventDef = "HERNAN";//this.eventManager.getEventDefByUid(legacyInstances[i]._id);
        console.log("eventDef: ",seg.footprint.eventDef.miscProps);
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderSlatRowHtml = function () {
        ...
        while (slotTime < dateProfile.maxTime) {
            ...
            var hora = slotDate.format('HH:mm:ss');
            axisHtml =
                '<td class="fc-axis fc-time ' + theme.getClass('widgetContent') + '" ' + view.axisStyleAttr() + '>' +
                    ...
                    '</td>';
            html +=
                '<tr data-time="' + slotDate.format('HH:mm:ss') + '" data-fecha="' + slotDate.format('YYYY-MM-DD') +
                '" data-date="' + slotDate.format('DD/MM/YYYY') + '"onclick="clickDia(this)"' +
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.renderSegList = function (allSegs) {
        ...
        var daySegs;
        var i;
        var tableEl = $('<table class="fc-list-table col-xs-12 col-md-12' + this.calendar.theme.getClass('tableList') + '"><tbody/></table>');
    ...
    ListView.prototype.dayHeaderHtml = function (dayDate) {
        ...
        return '<tr class="fc-list-heading" data-fecha="' + dayDate.format('YYYY-MM-DD') + '" data-date="' + dayDate.format('DD/MM/YYYY') + '">' +
...
var FiltroView_1 = __webpack_require__(72);
exports.FiltroView = FiltroView_1.default;
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.render = function () {
        ...
        if (sections) {
            ...
            el.append(this.renderSection('left'))
                ...
                .append(this.renderSection('abajo'))//Hernan
    ...
    Toolbar.prototype.renderSection = function (position) {
        ...
        var sectionEl = $('<div class="fc-' + position + '"/>');// agrega grupo botones del ttulo Hernan
        var buttonStr = this.toolbarOptions.layout[position];
        //console.log(buttonStr)
        //console.log(position)
        var calendarCustomButtons = optionsManager.get('customButtons') || {};
        //console.log(calendarCustomButtons)
        var calendarButtonTextOverrides = optionsManager.overrides.buttonText || {};
        //console.log(calendarButtonTextOverrides)
        var calendarButtonText = optionsManager.get('buttonText') || {};
        //console.log(calendarButtonText)
        if (buttonStr) {
            $.each(buttonStr.split(' '), function (i, buttonGroupStr) {
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    //console.log("buttonName0: ",buttonName);
                    ...
                    if (buttonName == 'title') {
                    	...
                    	//console.log("buttonName0.5: ",buttonName);
                    	//console.log("viewSpecManager: ",viewSpec," - ",viewSpecManager.getViewSpec(buttonName));
                        if ((customButtonProps = calendarCustomButtons[buttonName])) {
                            //console.log("customButtonProps: ",customButtonProps, " - ",calendarCustomButtons[buttonName]);//=undefined
                            buttonClick = function (ev) {
                                if (customButtonProps.click) {
                                    customButtonProps.click.call(buttonEl[0], ev);
                                }
                            };
                            //console.log("buttonIcon: ",buttonIcon, " - ",theme.getCustomButtonIconClass(customButtonProps))
                            (buttonIcon = theme.getCustomButtonIconClass(customButtonProps)) ||
                                (buttonIcon = theme.getIconClass(buttonName)) ||
                                (buttonText = customButtonProps.text);
                        }
                        else if ((viewSpec = viewSpecManager.getViewSpec(buttonName))) {
                            //console.log("viewSpec: ",viewSpec," - ", viewSpecManager.getViewSpec(buttonName))
                        	//console.log("buttonName1: ",buttonName)
                        	...
                        	//console.log("buttonName2: ",buttonName)
                            buttonClick = function () {
                                calendar[buttonName]();
                            };
...
var ViewSpecManager = /** @class */ (function () {
    ...
    ViewSpecManager.prototype.getViewSpec = function (viewType) {
        ...
        ///console.log("viewType0: ",this.buildViewSpec(viewType))
...
BootstrapTheme.prototype.classes = {
    ...
    // filtro view
    filtroView: 'panel panel-default'
};
...
BootstrapTheme.prototype.iconClasses = {
    ...
    doctor: 'glyphicon-chevron-left',
    especialidad: 'glyphicon-chevron-right'
};
...
views.agenda = {
    ...
    defaults: {
        allDaySlot: true,
        slotDuration: '00:20:00',// duracion de lineas segun agenda dia Hernan
...
views.list = {
    ...
    defaults: {
        buttonText: 'list',
        listDayFormat: 'LL',
        noEventsMessage: 'No se persentaron eventos'
    }
};
views.listDay = {
    type: 'list',
...
/*****************************Hernan Nuevos botones en elencabezado ***********************/
/***/ }),
/* 98 */
/***/ (function(module, exports, __webpack_require__) {
...
var View_1 = __webpack_require__(30);
var Scroller_1 = __webpack_require__(28);
var FiltroEventRenderer_1 = __webpack_require__(90);
var FiltroEventPointing_1 = __webpack_require__(91);
/*
Responsible for the scroller, and forwarding event-related actions into the "grid".
*/
var FiltroView = /** @class */ (function (_super) {
    tslib_1.__extends(FiltrotView, _super);
    function FiltroView(calendar, viewSpec) {
        var _this = _super.call(this, calendar, viewSpec) || this;
        _this.segSelector = '.fc-filtro-item'; // which elements accept event actions
        _this.scroller = new Scroller_1.default({
            overflowX: 'hidden',
            overflowY: 'auto'
        });
    ...
    FiltroView.prototype.renderSkeleton = function () {
        /*this.el.addClass('fc-list-view ' +
            this.calendar.theme.getClass('listView'));
        this.scroller.render();
        this.scroller.el.appendTo(this.el);
    ...
    FiltroView.prototype.unrenderSkeleton = function () {
       // this.scroller.destroy(); // will remove the Grid too
    };
    FiltroView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
       // this.scroller.setHeight(this.computeScrollerHeight(totalHeight));
    };
    FiltroView.prototype.computeScrollerHeight = function (totalHeight) {
       /* return totalHeight -
            util_1.subtractInnerElHeight(this.el, this.scroller.el); // everything that's NOT the scroller*/
    };
    FiltroView.prototype.renderDates = function (dateProfile) {
        /*var calendar = this.calendar;
        var dayStart = calendar.msToUtcMoment(dateProfile.renderUnzonedRange.startMs, true);
        var viewEnd = calendar.msToUtcMoment(dateProfile.renderUnzonedRange.endMs, true);
        var dayDates = [];
    ...
    // slices by day
    FiltroView.prototype.componentFootprintToSegs = function (footprint) {
        /*var dayRanges = this.dayRanges;
        var dayIndex;
        var segRange;
        var seg;
    ...
    FiltroView.prototype.renderEmptyMessage = function () {
        /*this.contentEl.html('<div class="fc-list-empty-wrap2">' + // TODO: try less wraps
            '<div class="fc-list-empty-wrap1">' +
            '<div class="fc-list-empty">' +
            util_1.htmlEscape(this.opt('noEventsMessage')) +
    ...
    // render the event segments in the view
    FiltroView.prototype.renderSegList = function (allSegs) {
       /* var segsByDay = this.groupSegsByDay(allSegs); // sparse array
        var dayIndex;
        var daySegs;
        var i;
    ...
    // Returns a sparse array of arrays, segs grouped by their dayIndex
    FiltroView.prototype.groupSegsByDay = function (segs) {
        /*var segsByDay = []; // sparse array
        var i, seg;
        for (i = 0; i < segs.length; i++) {
            seg = segs[i];
    ...
    // generates the HTML for the day headers that live amongst the event rows
    FiltroView.prototype.dayHeaderHtml = function (dayDate) {
        /*var mainFormat = this.opt('listDayFormat');
        var altFormat = this.opt('listDayAltFormat');
...
exports.default = FiltroView;
FiltroView.prototype.eventRendererClass = FiltroEventRenderer_1.default;
FiltroView.prototype.eventPointingClass = FiltroEventPointing_1.default;
/***/ }),
/* 99 */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var namespace_hooks_1 = __webpack_require__(7);
var FiltroView_1 = __webpack_require__(98);
var views = namespace_hooks_1.default.views;
views.filtro = {
    'class': FiltroView_1.default,
    buttonTextKey: 'list',
    defaults: {
        buttonText: 'list',
        listDayFormat: 'LL',
