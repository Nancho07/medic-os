...
var EventRenderer = /** @class */ (function () {
    ...
    EventRenderer.prototype.getTimeText = function (eventFootprint, formatStr, displayEnd) {
        //console.log(eventFootprint.eventInstance.def.source)
    ...
    */
    ...
    ArrayEventSource.parse = function (rawInput, calendar) {
        ...
        if ($.isArray(rawInput.events)) {
            rawProps = rawInput;
            //console.log("rawProps-rawInput.events",rawProps);//Hernan
        }
        else if ($.isArray(rawInput)) {
            rawProps = { events: rawInput };
            //console.log("rawProps-rawInput",rawProps);
        }
        if (rawProps) {
...
var Calendar = /** @class */ (function () {
    ...
    */
    Calendar.prototype.footprintToDateProfile = function (componentFootprint, ignoreEnd) {
        ...
        console.log("EventDateProfile_1: ",EventDateProfile_1.default(start, end, this));
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        //console.log("HERNAN: ",this.getSegClasses(seg, isDraggable, isResizableFromStart || isResizableFromEnd))
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        // aqui se cargan los eventos Hernan //
        //console.log(this.getTimeText(seg.footprint))
        titleHtml =
            '<span class="fc-title">' +
