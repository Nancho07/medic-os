...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
          ...
          + "<input id='d_fijo' type='checkbox' data-layout='fixed' class='pull-right'/> "
          + "Diseño fijo"
          + "</label>"
  ...
  function store(name, val) {
    if (typeof (Storage) !== "undefined") {
      ...
      alert('Utilice un navegador moderno para ver correctamente esta plantilla!');
    }
  }
  ...
  function get(name) {
    if (typeof (Storage) !== "undefined") {
      ...
      alert('¡Usa un navegador moderno para ver esta plantilla correctamente!');
    }
  }
